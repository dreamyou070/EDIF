...
class StableDiffusion3InstructPix2PixPipeline(DiffusionPipeline, SD3LoraLoaderMixin, FromSingleFileMixin):
    ...
    def __call__(
            ...
            origin=True,
            structure_ideal_low=0.4,
            structure_ideal_high=0.8,
        ...
        (
            ...
            negative_prompt_2=negative_prompt_2,
            negative_prompt_3=negative_prompt_3,
            # 어디서 self.do_classifier_free_guiodance 가 나온거지?
        ...
        if self.do_classifier_free_guidance :
            im_latent = image_latents[0:1,:,:,:]
        else :
            im_latent = image_latents
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if origin :
                    ...
                    latents = self.onetime_inference(
                        latents=latents,
