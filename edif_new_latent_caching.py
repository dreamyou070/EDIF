...
def main(args):
        ...
        if txt_decision.strip().lower() == 'no':
            ...
            for k in controller.txt_alpha_dict:
                ...
                if k in ETB:
                    ...
                    new_txt_alpha = min(3.0, old_txt_alpha + delta_txt * 0.5)
    ...
    save_folder_base = f'/data2/CVPR_Public/Kontext_EDIF_demo_new_latent_caching_{args.latent_change_threds}'
    ...
    for data in contents:
        ...
        attention_idx = 0
        for name, module in flux_transformer.nametttd_modules():
